...
input double inpKhoangCachNhoiLenhDauTien=30;//Khoang cach nhoi lenh dau tien (pips):
input double inpHeSoNhoiLenh=2;// He so nhan khoi luong:
//input double inpHeSoCongKhoangCach=1;// He so cong khoang cach nhoi lenh:
...
input bool inpChoPhepDongLenhKhiGiaoCatMa=true;// Chp phep dong lenh khi gia cat MA:
input string str0="THAM SO HAI DUONG MA ";//CAI DAT THAM SO MA:
input ENUM_TIMEFRAMES inpTFKhung=PERIOD_M5;//Timeframe tinh MA:
input int inpMAPeriodNgan=10;// MA Period:
...
void OnTick()
{
   ...
   {
      if(inpChoPhepDongLenhKhiGiaoCatMa) FunDongLenhKhiCatMA();
