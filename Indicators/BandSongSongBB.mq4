...
input double inpSoPipChotLoiDangBand=5.0;//So pip cua duong band chot loi 1 cach band tren/duoi (Pips)
//--- buffers
   ...
   for(i=pos; i<rates_total && !IsStopped(); i++)
     {
      ...
      //--- upper line
      ExtUpperBuffer[i]=ExtMovingBuffer[i]+InpBandsDeviations*ExtStdDevBuffer[i]-inpSoPipChotLoiDangBand*10*Point();
      //--- lower line
      ExtLowerBuffer[i]=ExtMovingBuffer[i]-InpBandsDeviations*ExtStdDevBuffer[i]+inpSoPipChotLoiDangBand*10*Point();
      //---
     }
